...
if __name__ == "__main__":
    ...
    plt.plot(df["files_per_req"], df["og_rps"], marker='o', linestyle='-', color='gray', linewidth=2, label='Sequenziale - 1 Core')
    plt.plot(df["files_per_req"], df["mt1_1_rps"], marker='o', linestyle='-', color='greenyellow', linewidth=2, label='Parallelo - 1 Core')
    plt.plot(df["files_per_req"], df["mt4_1_rps"], marker='o', linestyle='-', color='red', linewidth=2, label='Parallelo - 3 Core')
    ...
    plt.title("Solo 1 Core Attivo", fontsize=14)
    plt.xlabel("Numero di File per Richiesta", fontsize=12)
    plt.ylabel("Richieste al secondo", fontsize=12)
    ...
    plt.figure(figsize=(10, 6))
    plt.plot(df["files_per_req"], df["og_stage_avg"], marker='o', linestyle='-', color='gray', linewidth=2, label='Sequenziale - 1 Core')
    plt.plot(df["files_per_req"], df["mt1_1_stage_avg"], marker='o', linestyle='-', color='blue', linewidth=2, label='Parallelo - 1 Core')
    plt.plot(df["files_per_req"], df["mt4_1_stage_avg"], marker='o', linestyle='-', color='darkblue', linewidth=2, label='Parallelo - 3 Core')
